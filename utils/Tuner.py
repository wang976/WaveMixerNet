...
class Tuner:
    ...
    def optuna_objective(self, trial, args):
        ...
        args.cfactor = trial.suggest_categorical('cfactor', args.optuna_cfactor) 
        ...
        setting = '{}_{}_sl{}_pl{}_dm{}_bt{}_wv{}_tf{}_df{}_cf{}_ptl{}_stl{}_sd{}'.format(args.model, args.data, args.seq_len, args.pred_len, args.d_model, args.batch_size, args.wavelet, args.tfactor, args.dfactor, args.cfactor, args.patch_len, args.stride, self.fixedSeed)
    ...
    def save_result(self, args):
        file_name = '{}_{}_s{}_p_{}_decom-{}'.format(args.model, args.data, args.seq_len, args.pred_len, not args.no_decomposition)
        data, pred_len = args.data, args.pred_len
        # best trial
        best_trial = self.study.best_trial
        # best_params
        best_params = dict(self.study.best_params)
        if 'cfactor' not in best_params and hasattr(args, 'cfactor'):
            best_params['cfactor'] = args.cfactor
        # best result 
